            ...
            <main className="mx-auto flex w-full max-w-7xl flex-col gap-28 px-5 py-10">
                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-5">
                                ...
                                <p className="max-w-xl text-lg leading-8 text-slate-300">
                                    Comprima PDFs, converta imagens, compacte
                                    vídeos e organize arquivos diretamente do
                                    navegador.
                                </p>
                            </div>
                ...
                <section className="flex flex-col gap-5">
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="max-w-3xl text-lg leading-8 text-slate-400">
                            Utilize ferramentas rápidas e modernas para
                            manipular PDFs, imagens, vídeos, documentos e
                            diversos outros formatos online.
                        </p>
                    </div>
                    ...
                    <div>
                        <div>
                            ...
                            <p className="leading-8 text-slate-400">
                                Faça upload dos seus arquivos, escolha a
                                ferramenta desejada e baixe o resultado em
                                segundos.
                            </p>
                        </div>
                ...
                <section className="flex flex-col gap-5">
                    <div className="flex flex-col gap-3">
                        ...
                        <p className="max-w-3xl text-lg leading-8 text-slate-400">
                            Você pode utilizar as ferramentas sem cadastro,
                            porém usuários autenticados possuem acesso ilimitado
                            e uma experiência mais completa.
                        </p>
                    </div>
